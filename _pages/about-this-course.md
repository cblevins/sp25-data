...
This course is a bit odd. Unlike a typical humanities course, you'll be learning how to code. And unlike a typical coding course, you'll be studying data through a deeply historical lens. While these two features might seem quite distinct from each other, together they will help you understand both how to more effectively work with data.
...
It is tempting to focus on the results of these activities: completing a tutorial as quickly as possible or just making sure you get "the right answer" for a homework question. But skill-building comes from **the process itself**. Don't rush through material or passively follow instructions. Experiment and try things out; if you don't really understand _why_ a piece of code worked, try editing some of it and figure out what it changes. I promise you that in the long run this approach will be more effective and efficient than mindlessly completing something in order to check it off your to-do list.

Most importantly: **coding is quite literally built on failure.** No matter how talented or experienced, nobody writes flawless code from scratch. In fact, the coding process is almost always: write some code, realize it doesn't work, and try figure out what's wrong and how to fix it. The moments of confusion and struggle when you learn the most.
...
This course is **scaffolded**; each week builds sucessively on what you've learned in previous weeks. During the first 2-3 months of the semester you will be learning the fundmentals of how to code and how to think historically about data. During this time you will be building up your coding and critical thinking muscles through structured tutorials, readings, and homework assignments. In the last portion of the semester, you're going to put those new muscles to use. You will be applying what you've learned to create your own data-driven project. During this phase of the course, you have much wider latitude to follow your interests and goals. I will be working with each of you to develop your project.

## Course Policies

### Grades

Full disclosure: **I hate grades.** I've found that traditional grading causes students to focus on the wrong things: "What do I need to do to get an A in this course?" rather than "How do I learn the most in this course?" My main priority as a teacher is that this course is as useful as possible to you. Each of you have different starting points, perspectives, and goals in terms of what you would like to get out of this semester. Some of you might already have technical experience; others might be starting from scratch. Regardless of your starting point, my goal is to foster experimentation, creativity, ande even failure.
...
Generative AI tools (like ChatGPT) present a major challenge for a class like this. I'll be completely transparent: you could complete most of the tutorials, homework assignments, etc. using ChatGPT and finish them in a fraction of the time (and likely with better answers) than you would on your own. You are all incredibly busy; so why _wouldn't_ you do this? There are a few reasons:

- Learning to code is like building a muscle; it takes repetition and practice. Using Generative AI to write code for you would be like having someone else lift weights for you at the gym - it might get the task finished, but you're not getting any of the benefits from it. If your goal is to actually learn _how_ to code (rather than completing assignments), then using Generative AI actively keeps you from learning that.
- Coding requires problem-solving skills and mental models. When you wrestle with a coding challenge, debug errors, or figure out why your code isn't working, you're building essential knowledge and skills.
- AI coding suggestions can be misleading or incorrect, especially for beginners. The code might run, but it often doesn't follow best practices or teach you why certain approaches work better than others.

I encourage you to be honest if you're struggling with concepts or assignments. I would much rather have you come to office hours or reach out for help than turn to AI tools. Remember: the goal of this course isn't to write perfect code - it's to develop your own understanding and capabilities.
...
With some exceptions, I will be available each week on Wednesday from 1:30-2:30pm, along with additional timeslots that I will post on a week-to-week basis. Use [this link](https://outlook.office365.com/owa/calendar/ProfBlevinsSpring2025OfficeHours@cuanschutz.edu/bookings/s/jL7GGvwk8Uy3t9An0rnVXQ2) to see a list of available timeslots and then sign up for one that best fits your schedule. If none of these times work for your schedule, please contact me over Canvas Inbox or email and we will find a different time to meet. _Note: in order to make it as easy as possible to meet and accommodate student schedules, I will hold all office hours virtually over Zoom ([link here](https://ucdenver.zoom.us/j/91012819482)). However, I love face-to-face conversations - if you prefer to meet in person, send me a message and we can find a time to meet in my office (Student Commons 3108)._
